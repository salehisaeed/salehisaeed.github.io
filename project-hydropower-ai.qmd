...
**PhD recruitment update (September 2026):** the application period closed on 31 August 2026, and the assessment and recruitment process has now started. We received a large number of applications, so the process will take some time. Thank you to all applicants for your patience. This page describes the research project.
:::
...
The project is funded by the [ÅForsk Foundation](https://aforsk.com/PreviousWinners) through an Early-Career Research Grant, with co-funding from Linköping University.\
